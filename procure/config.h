/* procure/config.h.  Generated from config.h.in by configure.  */
...
/* Name of package */
#define PACKAGE "procure"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "mvc@fct.unl.pt"

/* Define to the full name of this package. */
#define PACKAGE_NAME "procure"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "procure 1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "procure"
